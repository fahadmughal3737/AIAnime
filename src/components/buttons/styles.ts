...
export const styles = {
    ...
    smallButton:{ backgroundColor: 'green', flexDirection: 'row', height: heightPercentageToDP(6), borderColor: COLORS.PINK01, borderWidth: 2, paddingHorizontal: '2.5%', justifyContent: 'center', alignItems: 'center', width: widthPercentageToDP(43), borderRadius: normalize(40) },
}